...
def DMF(axs, i):
    ...
    if(i == 0):
        axs.errorbar(VlahakisA_2005['DM'] ,np.log10(VlahakisA_2005['Phi']) ,yerr=(np.log10(VlahakisA_2005['Phi_down_err']/VlahakisA_2005['Phi']),np.log10(VlahakisA_2005['Phi_up_err']/VlahakisA_2005['Phi'])) ,color='g',label=r'$VlahakisA+2005$',fmt='.')
        axs.errorbar(VlahakisB_2005['DM'] ,np.log10(VlahakisB_2005['Phi']) ,yerr=(np.log10(VlahakisB_2005['Phi_down_err']/VlahakisB_2005['Phi']),np.log10(VlahakisB_2005['Phi_up_err']/VlahakisB_2005['Phi'])) ,color='red',label=r'$VlahakisB+2005$',fmt='.')
        axs.errorbar(Clemens_2013['DM'], Clemens_2013['Phi'], yerr = (Clemens_2013['Phi'] + Clemens_2013['Phi_down_err'],Clemens_2013['Phi'] + Clemens_2013['Phi_up_err']),color='b',label=r'$Clemens+2013$',fmt='.')            
